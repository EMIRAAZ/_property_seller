...
import Building from "../../../components/svgicons/Building";
  ...
  return (
    <div className="home-form-card">
      <div className="home-formcard">
        ...
        <div className="form-propertyType-container">
          <div className="form-propertyType-div">
            <button className="form-propertyType-button">Appatment</button>
          </div>
          <div className="form-propertyType-div">
            <button className="form-propertyType-button">Villa</button>
          </div>
          <div className="form-propertyType-div">
            <button className="form-propertyType-button">Townhall</button>
          </div>
          <div className="form-propertyType-div">
            <button className="form-propertyType-button">Estae</button>
          </div>
        </div>
